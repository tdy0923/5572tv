  ...
  return (
    <div className='md:block md:order-first md:col-span-1'>
      <div className='md:py-4 md:pr-6'>
        ...
        <div className='mx-auto mb-4 max-w-[220px] md:mx-0 md:mb-0 md:max-w-none md:w-auto group relative flex aspect-[2/3] w-full md:w-auto items-center justify-center overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 bg-linear-to-br from-gray-100 to-gray-200 shadow-md dark:border-gray-700 dark:from-gray-800 dark:to-gray-700'>
          {coverSrc ? (
            <>
              <button
                type='button'
