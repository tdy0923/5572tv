...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      {resolvedTheme === 'dark' ? (
        <Sun className='relative z-10 h-7 w-7 group-hover:rotate-180 transition-transform duration-500' />
      ) : (
        <Moon className='relative z-10 h-7 w-7 group-hover:rotate-180 transition-transform duration-500' />
      )}
    </button>
  );
}
