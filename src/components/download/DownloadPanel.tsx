  ...
  return (
    <div className='fixed inset-0 z-65 overflow-y-auto'>
      <div className='flex items-end md:items-center justify-center min-h-screen md:min-h-full p-0 md:p-4'>
        ...
        {/* 模态框内容 */}
        <div className='relative bg-white dark:bg-gray-800 rounded-t-2xl md:rounded-lg shadow-28 w-full md:max-w-4xl h-fit max-h-[80vh] md:max-h-[85vh] flex flex-col border-t md:border border-gray-200 dark:border-gray-700 overflow-hidden'>
          {/* 标题栏 */}
