...
const MobileActionSheet: React.FC<MobileActionSheetProps> = ({
  ...
  useEffect(() => {
    ...
    requestAnimationFrame(() => setPortalEl(el));

    return () => {
      try {
        document.body.removeChild(el);
      } catch (e) {
        /* noop - container may have been removed */
      }
    };
  }, []);
  ...
  const renderContent = () => (
    ...
    >
      ...
      {/* 操作表单 */}
      <div
        className='relative w-full max-w-lg mx-4 mb-4 bg-white dark:bg-gray-900 rounded-2xl shadow-28 transition-all duration-200 ease-out'
        onTouchMove={(e) => {
      ...
      >
        ...
        <div className='flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800'>
          ...
          <button
            onClick={onClose}
            aria-label='关闭'
            className='p-3 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-150'
          >
