        ...
        {options.map((opt, index) => {
          ...
          return (
            <button
              ...
              className={`relative z-10 min-w-[60px] rounded-full px-3 py-2.5 text-xs font-semibold transition-all duration-200 cursor-pointer sm:min-w-[80px] sm:py-2.5 sm:text-sm ${
                isActive
                  ? 'text-[#171717]'
