...
const CLOUD_TYPES = {
  ...
  tianyi: {
    name: '天翼云盘',
    color: 'bg-red-500',
    lightColor: 'bg-red-500/10 hover:bg-red-500/20',
    icon: '📱',
    domain: 'cloud.189.cn',
  },
  uc: {
    name: 'UC网盘',
    color: 'bg-green-500',
    lightColor: 'bg-green-500/10 hover:bg-green-500/20',
    icon: '🌐',
    domain: 'drive.uc.cn',
  },
  mobile: {
    name: '移动云盘',
    color: 'bg-cyan-500',
    lightColor: 'bg-cyan-500/10 hover:bg-cyan-500/20',
    icon: '📲',
  ...
  '115': {
    name: '115网盘',
    color: 'bg-gray-500',
    lightColor: 'bg-gray-500/10 hover:bg-gray-500/20',
    icon: '💾',
    domain: '115.com',
  },
  pikpak: {
  ...
  xunlei: {
    name: '迅雷网盘',
    color: 'bg-yellow-500',
    lightColor: 'bg-yellow-500/10 hover:bg-yellow-500/20',
    icon: '⚡',
  ...
  '123': {
    name: '123网盘',
    color: 'bg-indigo-500',
    lightColor: 'bg-indigo-500/10 hover:bg-indigo-500/20',
    icon: '🔢',
    domain: '123pan.com',
  },
  magnet: {
    name: '磁力链接',
    color: 'bg-black',
    lightColor: 'bg-black/10 hover:bg-black/20',
    icon: '🧲',
    domain: 'magnet:',
  },
  ed2k: {
    name: '电驴链接',
    color: 'bg-teal-500',
    lightColor: 'bg-teal-500/10 hover:bg-teal-500/20',
    icon: '🐴',
    domain: 'ed2k://',
  },
  others: {
    name: '其他',
    color: 'bg-gray-400',
    lightColor: 'bg-gray-400/10 hover:bg-gray-400/20',
    icon: '📄',
    domain: '',
  },
};
...
export default function NetDiskSearchResults({
  ...
  useEffect(() => {
    ...
    requestAnimationFrame(() => setIsLargeScreen(mediaQuery.matches));
