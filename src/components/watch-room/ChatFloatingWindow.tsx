...
export default function ChatFloatingWindow() {
  ...
  if (!isOpen && !showRoomInfo) {
    return (
      <div className='fixed bottom-[calc(80px+env(safe-area-inset-bottom))] right-4 z-60 flex flex-col gap-2 sm:gap-3 sm:bottom-24 sm:right-6 md:bottom-24'>
        {/* 房间信息按钮 */}
        <button
  ...
  if (showRoomInfo) {
    return (
      <div className='fixed inset-x-4 bottom-[calc(80px+env(safe-area-inset-bottom))] z-60 rounded-t-2xl sm:inset-x-auto sm:bottom-24 sm:right-6 sm:w-80 sm:rounded-2xl bg-white dark:bg-gray-800 shadow-2xl max-h-[70vh] sm:max-h-[600px] flex flex-col'>
        {/* 头部 - Fixed */}
  ...
  return (
    <div
      className='fixed inset-x-4 bottom-[calc(80px+env(safe-area-inset-bottom))] z-60 flex flex-col rounded-t-2xl sm:inset-x-auto sm:bottom-24 sm:right-6 sm:w-80 sm:rounded-2xl bg-white dark:bg-gray-800 shadow-2xl'
      ...
      <div className='shrink-0 border-t border-gray-200 dark:border-gray-700 p-2.5 sm:p-4'>
        ...
        <div className='flex gap-1.5 sm:gap-2'>
          ...
          <input
            ...
            placeholder='输入消息...'
            className='flex-1 min-w-0 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-2.5 py-1.5 sm:px-3 sm:py-2 text-sm sm:text-base text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500'
          />
          <button
