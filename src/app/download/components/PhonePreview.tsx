...
export default function PhonePreview() {
  return (
    <div className='relative'>
      {/* 发光背景 */}
      <div className='absolute -inset-10 bg-[#f4c24d]/15 rounded-full blur-[80px] -z-10' />

      {/* 手机框 - 桌面端大尺寸 */}
      <div className='w-[220px] sm:w-[280px] h-[470px] sm:h-[600px] bg-[#111] rounded-[2.5rem] sm:rounded-[3rem] border-[5px] sm:border-[6px] border-gray-500 overflow-hidden shadow-[0_0_30px_rgba(244,194,77,0.15),0_25px_50px_-12px_rgba(0,0,0,0.8)] relative'>
        {/* 状态栏 */}
