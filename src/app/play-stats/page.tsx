  ...
  if (isAdmin && statsData && userStats) {
    return (
      <PageLayout activePath='/play-stats'>
        ...
        <button
          onClick={scrollToTop}
          className={`fixed bottom-[calc(80px+env(safe-area-inset-bottom))] md:bottom-6 right-6 z-500 w-12 h-12 bg-green-500/90 hover:bg-green-500 text-white rounded-full shadow-lg backdrop-blur-sm transition-all duration-300 ease-in-out flex items-center justify-center group ${
            showBackToTop
