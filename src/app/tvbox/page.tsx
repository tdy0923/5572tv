  ...
  return (
    <PageLayout activePath='/tvbox'>
      <div className='max-w-4xl mx-auto p-4 md:p-6'>
            ...
            <div className='flex items-start gap-3'>
              ...
              <div className='flex-1'>
                ...
                <div className='text-sm text-blue-800 dark:text-blue-200 space-y-1.5'>
                  ...
                  <p>
                    <strong>
                      <Lock className='w-4 h-4 inline' /> 成人内容过滤：
                    </strong>
            ...
            securityConfig.enableRateLimit ? (
              <div className='bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg p-4'>
                <div className='flex items-start gap-3'>
                  ...
                  <div>
                    <h3 className='font-semibold text-green-800 dark:text-green-200 mb-1 flex items-center gap-1'>
                      <Lock className='w-4 h-4' /> 已启用安全配置
                    </h3>
              ...
              <div className='bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4'>
                <div className='flex items-start gap-3'>
                  ...
                  <div>
                    <h3 className='font-semibold text-yellow-800 dark:text-yellow-200 mb-1 flex items-center gap-1'>
                      <AlertTriangle className='w-4 h-4' /> 安全提醒
                    </h3>
        ...
        {/* 📖 使用指南 - 简单三步 */}
        <div className='bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-700 rounded-2xl p-6 mb-6'>
        ...
        <div className='bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-6 border border-gray-200 dark:border-gray-700'>
          ...
          <div className='mb-4'>
            ...
            <p className='text-xs text-gray-500 dark:text-gray-400 mt-2'>
              {configMode === 'standard' ? (
                ...
                <>
                  <Lock className='w-4 h-4 inline' /> 仅核心配置，TVBox
                  兼容性问题时使用
                </>
              ) : configMode === 'fast' ? (
          ...
          <div className='flex items-center space-x-2'>
            ...
            >
              {copied ? (
                <>
                  <Check className='w-4 h-4 inline' /> 已复制
                </>
              ) : (
                '复制'
              )}
        ...
        <div className='mb-6'>
          <button
            ...
            className='w-full flex items-center justify-between px-5 py-4 bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-200 dark:border-gray-700 hover:border-blue-400 dark:hover:border-blue-500 transition-colors'
          >
                            ...
                            <>
                              ...
                              <div className='p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-700'>
                                <h3 className='font-semibold text-green-900 dark:text-green-300 mb-3'>
                                  <Check className='w-4 h-4 inline' /> 基本信息
                                </h3>
                              ...
                              {diagnosisResult.spider_candidates &&
                                diagnosisResult.spider_candidates.length >
                                  0 && (
                            ...
                            <>
                              ...
                              <div className='p-4 bg-gray-50 dark:bg-gray-700 rounded-lg'>
                                ...
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-2 text-sm'>
                                  ...
                                  >
                                    {smartHealthResult.spider.current
                                      .success ? (
                                      <>
                                        <Check className='w-4 h-4 inline' />{' '}
                                        成功
                                  ...
                                  <div className='text-gray-900 dark:text-gray-100 font-medium'>
                                    {Math.round(
                                      smartHealthResult.spider.current.size /
                                        1024,
                                    )}
                                    KB
                                  </div>
                              ...
                              <div className='flex-1'>
                                ...
                                <div className='mt-2 space-y-1 text-sm'>
                                  <div className='flex justify-between'>
                                    ...
                                    <span className='font-mono text-xs text-gray-900 dark:text-white break-all ml-2'>
                                      {customJarTestResult.url}
                                    </span>
                                  </div>
                                  {customJarTestResult.success && (
                                    <>
                                      <div className='flex justify-between'>
                                        ...
                                        <span className='font-semibold text-gray-900 dark:text-white'>
                                          {customJarTestResult.responseTime}ms
                                        </span>
                                      </div>
                                      ...
                                      <div className='flex justify-between'>
                                        ...
                                        <span className='font-semibold text-gray-900 dark:text-white'>
                                          {customJarTestResult.spiderSuccess ===
                                          'true' ? (
                                            <>
                                              <CheckCircle2 className='w-4 h-4 inline' />{' '}
                                              成功
                                      ...
                                      <div className='flex justify-between'>
                                        ...
                                        <span className='font-semibold text-gray-900 dark:text-white'>
                                          {customJarTestResult.cached === 'true'
                                            ? '已缓存'
                                            : '新获取'}
                                        </span>
                                      </div>
